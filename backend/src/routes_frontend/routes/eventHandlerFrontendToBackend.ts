...
type EventHandler = (payload: any, socket: Socket) => void;

function eventHandlerBackendToFrontend(ioFrontend: SocketIOServer): Record<string, EventHandler> {
  return {
...
const backendToAppEventHandlers: Record<string, EventHandler> = {
...
export { backendToAppEventHandlers as backendEventHandlers };
